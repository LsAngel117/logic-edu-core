...
public record CreateEvaluationPeriodRequest(
        ...
        String weight,
        @Schema(description = "Fecha de inicio en formato YYYY-MM-DD (opcional)", example = "2025-02-01")
        String startDate,
        @Schema(description = "Fecha de fin en formato YYYY-MM-DD (opcional)", example = "2025-03-15")
        String endDate
) {}
